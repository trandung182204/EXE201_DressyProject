...
function getContentTab(url,selector){
	...
	var loading = '<div class="a-center"><img src="//bizweb.dktcdn.net/100/566/174/themes/1008318/assets/rolling.svg?1757573124058" alt="loading"/></div>';
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
...
function getContentTab2(url,selector){
	...
	var loading = '<div class="row"><div class="col-xl-20 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-20 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-20 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-20 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div><div class="col-xl-20 col-lg-3 col-md-3 col-sm-6 col-xs-12 item_null"><div class="item_product_main"></div></div></div>';
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
